...
| jenkins\_instance\_public\_ip | The public IP of the Jenkins instance (if any) |
...
| jenkins_instance_access_configs | Jenkins server access configs | list | `[{}]` | no |
...
| jenkins_instance_private | Enable private Jenkins instance | string | `false` | no |
...
| jenkins_workers_private | Enable private Jenkins workers | string | `false` | no |
...
| jenkins_instance_public_ip | The public IP of the Jenkins instance (if any) |
